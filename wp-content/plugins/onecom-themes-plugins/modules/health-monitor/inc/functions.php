...
if ( ! function_exists( 'oc_sh_scripts' ) ) {
	function oc_sh_scripts( $hook_suffix ) {
		...
		if ( $hook_suffix === '_page_onecom-wp-health-monitor' || $hook_suffix === 'admin_page_onecom-wp-health-monitor' ) {
			...
			wp_enqueue_script( 'oc_sh_js', ONECOM_WP_URL . 'assets/' . $folder . 'js/oc_sh_script' . $extenstion . '.js', [
				'jquery',
			...
			wp_localize_script( 'oc_sh_js', 'oc_constants', [
				...
				'nonce_error'   => __( 'An error occurred. Please reload the page and try again', $onecom_wp ),
